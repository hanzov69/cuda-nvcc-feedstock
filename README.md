...
Once the `conda-forge` channel has been enabled, `cuda-crt, cuda-nvcc, cuda-nvcc_linux-64, cuda-nvcc_linux-aarch64, cuda-nvcc_win-64, cuda-nvcc_win-arm64, cuda-nvvm` can be installed with `conda`:
